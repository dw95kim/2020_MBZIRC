...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        if ros.flag_target == 1:
            ...
            ros.GoalAction_target.data.append(ros.init_tar[0])  # init x
            ros.GoalAction_target.data.append(ros.init_tar[1])  # init y
            ros.GoalAction_target.data.append(ros.init_tar[2])  # init z
