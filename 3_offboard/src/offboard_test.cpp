...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber local_pos_sub = nh_sub.subscribe ("/mavros/local_position/pose", 2,          &callback_local_pos);
    ...
    ros::Publisher pub_targetlist = nh_pub.advertise<visualization_msgs::Marker> ("/waypoint", 1);
    pub_target                    = nh_pub.advertise<visualization_msgs::Marker> ("/waypoint_target", 1);
