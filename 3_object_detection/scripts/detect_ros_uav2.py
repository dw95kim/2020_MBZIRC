...
class detector:
    def __init__(self):
        ...
        self.detect_pub = rospy.Publisher("/uav2/detection", Float32MultiArray, queue_size=1)
        self.bridge = CvBridge()
        #self.image_sub = rospy.Subscriber("/scout/forward/image_raw", Image, self.image_cb, queue_size=1, buff_size=2**24)
        self.image_sub = rospy.Subscriber("/uav1/image_raw", Image, self.image_cb, queue_size=1, buff_size=2**24)
